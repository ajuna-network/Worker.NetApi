...
//         new(Utils.HexToByteArray("0xe5be9a5092b81bca64be81d212e7f2f9eba183bb7a90954f7b76361f6edb5c0a"),
//             ExpandMode.Ed25519);
//
...
//         new(Utils.HexToByteArray("0x398f0c28f98885e046333d4a41c19cee4c37368a9832c6502f6cfd182e2aef89"),
//             ExpandMode.Ed25519);
//
...
//         //await TestNodeAsync($"wss://{NgrokWebSocketUrl}:9944");
//
...
//         var subscription1 =
//             await client.Author.SubmitAndWatchExtrinsicAsync(ActionExtrinsicUpdate, extrinsicMethod, Alice, 0, 64,
//                 cts.Token);
...
//         var subscription2 =
//             await client.Author.SubmitAndWatchExtrinsicAsync(ActionExtrinsicUpdate, extrinsicMethod, Bob, 0, 64,
//                 cts.Token);
...
//         for (var x = 0; x < boardStruct.Board.Value.Length; x++)
//         {
//             var column = boardStruct.Board.Value[x];
//             for (var y = 0; y < column.Value.Length; y++) board[x, y] = column.Value[y].Value;
//         }
//
