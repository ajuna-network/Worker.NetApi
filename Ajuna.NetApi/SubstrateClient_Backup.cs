...
//             await Task.Factory.StartNew(ReceiveLoop, _connectTokenSource.Token, TaskCreationOptions.LongRunning, TaskScheduler.Default);
//
...
//             //TODO: Dimitris Revisit
//             var loopToken = _connectTokenSource.Token;
...
//                     do {
//                         receiveResult = await _socket.ReceiveAsync(buffer, loopToken);
...
//             
//             Console.WriteLine($"Message Received: {_messageCounter}");
//             _messageCounter++;
